...
You can see your plot below based on the physicochemical properties choosen for the x and y axis, that are coloured by quality. A summary of the choosen variables are also provided, along with a summary of the *quality* variable.
